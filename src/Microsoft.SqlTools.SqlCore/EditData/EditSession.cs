...
namespace Microsoft.SqlTools.ServiceLayer.EditData
{
    ...
    {
        private ResultSetCore associatedResultSet;
        ...
        public static ResultSetCore ValidateQueryForSession(Query query)
        {
            ...
            ResultSetCore[] queryResultSets = query.Batches.SelectMany(b => b.ResultSets).ToArray();
        ...
        /// </summary>
        public static void CheckResultsForInvalidColumns(ResultSetCore results, string tableName)
        {
